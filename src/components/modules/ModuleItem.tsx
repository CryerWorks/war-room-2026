  ...
  return (
    <div className={`px-4 sm:px-5 py-3 ${isBlocked ? "opacity-60" : ""}`}>
      <div className="flex items-start gap-3">
        ...
        {isBlocked ? (
          <div
            className="mt-0.5 w-5 h-5 rounded border-2 border-zinc-700 flex items-center justify-center flex-shrink-0 text-zinc-500"
            role="img"
            aria-label={`Blocked by: ${incompleteDeps.join(", ")}`}
