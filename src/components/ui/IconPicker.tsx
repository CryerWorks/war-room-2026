  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`w-12 h-10 rounded-lg border flex items-center justify-center transition-colors ${
          value
      ...
      {/* Picker dropdown */}
      {open && (
        <div className="absolute top-12 left-0 z-50 w-72 rounded-xl border border-zinc-700 bg-zinc-900 shadow-xl overflow-hidden">
